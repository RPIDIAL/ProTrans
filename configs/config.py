...
parser = argparse.ArgumentParser(description="hyper-parameter for Diff-RRG")
# ========================= Dataset Configs ==========================
...
# ========================= Model Settings ============================
parser.add_argument('--vision_model', default='microsoft/rad-dino', type=str, help="vision model to use")
parser.add_argument('--llama_model', default='BioMistral/BioMistral-7B', type=str, help="LLM model to use")
...
parser.add_argument('--save_json_path', type=str, default="./save/$dataset/$version")
...
parser.add_argument('--scorer_types', type=list, default=['ROUGE_L', 'METEOR'])
...
parser.add_argument('--limit_val_batches', type=float, default=0.5, help='How much of validation dataset to check (float = fraction, int = num_batches).')
...
parser.add_argument('--max_epochs', type=int, default=4, help='Stop training once this number of epochs is reached')
